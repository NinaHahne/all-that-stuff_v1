...
function replaceCard() {
  ...
  if (stuffCards.length > 0){
    ...
    let shuffleButtonText = '<button type="submit"  onClick="replaceCard();">shuffle cards<br>&<br>draw a new one</button>';
...
function drawCardWithId(cardId) { // moves a card with given cardId to the top of the draw pile (if it is in the draw pile)
